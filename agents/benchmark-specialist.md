...
<!--ШПАРГАЛКА (benchmark-specialist)
  ...
  ДЕЛАТЬ: Запускать скрипты, анализировать results, верифицировать behavioral contracts
  ...
  ПРИМЕР: Task(benchmark-specialist, "Запустить полные бенчмарки и отчитаться о failing контрактах")
-->
