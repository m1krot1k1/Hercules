...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/m1krot1k1/Hercules")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Hercules Agent — Full Documentation\n",
        (
            "This file is the entire Hercules Agent documentation concatenated for LLM "
