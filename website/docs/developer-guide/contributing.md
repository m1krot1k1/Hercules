...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Hercules Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Hercules Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
```bash
git clone --recurse-submodules https://github.com/m1krot1k1/Hercules.git
cd hermes-agent
...
- **Profile-safe paths**: Never hardcode `~/.hermes` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/m1krot1k1/Hercules/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- Use [GitHub Issues](https://github.com/m1krot1k1/Hercules/issues)
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/m1krot1k1/Hercules/blob/main/LICENSE).
