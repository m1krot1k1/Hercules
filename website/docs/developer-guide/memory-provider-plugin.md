...
description: "How to build a memory provider plugin for Hercules Agent"
---

# Building a Memory Provider Plugin

Memory provider plugins give Hercules Agent persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. This guide covers how to build one.
