...
description: "Run Hercules Agent directly on an Android phone with Termux"
---

# Hermes on Android with Termux

This is the tested path for running Hercules Agent directly on an Android phone through [Termux](https://termux.dev/).
