...
description: "Install and deploy Hercules Agent with Nix — from quick `nix run` to fully declarative NixOS module with container mode"
---

# Nix & NixOS Setup

Hercules Agent ships a Nix flake with three levels of integration:
...
nix run github:m1krot1k1/Hercules -- setup
nix run github:m1krot1k1/Hercules -- chat

# Or install persistently
nix profile install github:m1krot1k1/Hercules
hermes setup
hermes chat
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:m1krot1k1/Hercules";
  };
...
```nix
{
  inputs.hermes-agent.url = "github:m1krot1k1/Hercules";
