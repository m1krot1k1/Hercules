...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  Hercules Agent  ──▶  GitHub API  ──▶  Review     │
...
- **Hercules Agent installed** — see the [Installation guide](/docs/getting-started/installation)
...
```
Run: gh pr list --repo m1krot1k1/Hercules --state open --limit 3
```
...
Run: gh pr diff 3888 --repo m1krot1k1/Hercules
```
