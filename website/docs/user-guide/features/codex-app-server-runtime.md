...
This runtime is **opt-in beta**. Working as of Hercules Agent 2026.5 + Codex CLI 0.130.0:
...
If you find a bug, [open an issue](https://github.com/m1krot1k1/Hercules/issues) with the output of `hermes logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
...
For implementation details, see [PR #24182](https://github.com/m1krot1k1/Hercules/pull/24182) and the [Codex app-server protocol README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md).
