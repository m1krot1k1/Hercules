...
sidebar_position: 7
title: "Docker"
description: "Running Hercules Agent in Docker and using Docker as a terminal backend"
---

# Hercules Agent — Docker

There are two distinct ways Docker intersects with Hercules Agent:
...
If this is your first time running Hercules Agent, create a data directory on the host and start the container interactively to run the setup wizard:
