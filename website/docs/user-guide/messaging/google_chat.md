...
sidebar_position: 12
title: "Google Chat"
description: "Set up Hercules Agent as a Google Chat bot using Cloud Pub/Sub"
---

# Google Chat Setup

Connect Hercules Agent to Google Chat as a bot. The integration uses Cloud Pub/Sub
