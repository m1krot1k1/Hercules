...
sidebar_position: 3
title: "Discord"
description: "Set up Hercules Agent as a Discord bot"
---
...
3. Enter a name for your application (e.g., "Hercules Agent") and accept the Developer Terms of Service.
4. Click **Create**.
...
The bot token is the credential Hercules Agent uses to log in as your bot. Still on the **Bot** page:
...
Hercules Agent uses your Discord User ID to control who can interact with the bot. To find it:
...
## Step 8: Configure Hercules Agent
...
Hercules Agent supports Discord voice messages:
