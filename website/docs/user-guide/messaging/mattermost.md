...
3. Fill in the details:
   - **Username**: e.g., `hermes`
   - **Display Name**: e.g., `Hercules Agent`
...
Hercules Agent uses your Mattermost User ID to control who can interact with the bot. To find it:
...
## Step 5: Configure Hercules Agent
...
- **No extra dependencies**: The adapter uses `aiohttp` for HTTP and WebSocket, which is already included with Hercules Agent.
