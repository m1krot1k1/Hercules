...
sidebar_position: 1
title: "Telegram"
description: "Set up Hercules Agent as a Telegram bot"
---
...
2. Send `/newbot`
3. Choose a **display name** (e.g., "Hercules Agent") — this can be anything
...
Hercules Agent uses numeric Telegram user IDs to control access. Your user ID is **not** your username — it's a number like `123456789`.
...
Hercules Agent works in Telegram group chats with a few considerations:
