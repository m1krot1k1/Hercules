...
into Hercules Agent, archives selected unmapped docs for manual review, and
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Migrate OpenClaw user state into Hercules Agent.")
