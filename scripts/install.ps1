...
$RepoUrlSsh = "git@github.com:m1krot1k1/Hercules.git"
$RepoUrlHttps = "https://github.com/m1krot1k1/Hercules.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/m1krot1k1/Hercules/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/m1krot1k1/Hercules/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/m1krot1k1/Hercules/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/m1krot1k1/Hercules/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
