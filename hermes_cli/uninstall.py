    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                # Skip the "# Hercules Agent" comment and following line
                if '# Hercules Agent' in line or '# hermes-agent' in line:
                    skip_next = True
                    continue
...
def run_uninstall(args):
    ...
    print(color("│            ⚕ Hercules Agent Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  iex (irm https://raw.githubusercontent.com/m1krot1k1/Hercules/main/scripts/install.ps1)", Colors.DIM))
        else:
            print(color("  curl -fsSL https://raw.githubusercontent.com/m1krot1k1/Hercules/main/scripts/install.sh | bash", Colors.DIM))
        print()
    ...
    print()
    print("Thank you for using Hercules Agent! ⚕")
    print()
