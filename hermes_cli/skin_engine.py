...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Hercules Agent"         # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Hercules "       # Response box header label
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Hercules Agent",
            "welcome": "Welcome to Hercules Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Hercules ",
            "prompt_symbol": "❯",
